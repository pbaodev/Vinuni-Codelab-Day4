...
def submit_support_ticket(
    ...
    # Load trước rồi mới ghi — tránh ghi đè toàn bộ ticket cũ (Trap 2)
    existing_tickets = []
...
TOOL_DEFINITIONS = [
    {
        ...
        "description": (
            "Tra cứu sản phẩm/dịch vụ Vingroup (xe điện VinFast, resort Vinpearl) "
            "theo danh mục và giá tối đa. Dùng khi khách hỏi xem/tìm sản phẩm hoặc giá."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Tạo ticket hỗ trợ khi khách báo lỗi, khiếu nại hoặc gửi phản hồi. "
            "Trả về ticket_id để khách theo dõi."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "priority": {
                    "type": "string",
                    "description": "Mức ưu tiên: 'high' nếu nghiêm trọng/gấp, 'low' nếu nhẹ, còn lại 'medium'.",
